  ...
  return(
    <div className="active-light">
       ...
       <div className="menu-header">
                      ...
                      <div className="sub-menu-section">
                         <div className="sub-menu-center-block">
                            <div className="sub-menu-column smfull">
                               <ul>
                                  <li><Link to="/schooling">Schooling</Link> </li>
                                  <li><Link to="/it_training">It Training</Link> </li>
                                  <li><Link to="/competitive">Compititve Exams</Link> </li>
                               </ul>
                            </div>
                         </div>
                      </div>
         ...
         <li className="hidemobile"><Link data-bs-toggle="offcanvas" to="#offcanvasExample" className="btn-round- btn-br bg-btn2"><i className="fas fa-phone-alt"></i></Link></li>
         <li className="hidemobile"><Link to ="/Contact_Form" className="btn-br bg-btn3 btshad-b2 lnk">Registration <span className="circle"></span></Link> </li>    
         <li className="hidemobile"><Link to ="/login" className="btn-br bg-btn3 btshad-b2 lnk">Login <span className="circle"></span></Link> </li>  
        {/* 
         <li className="hidemobile"><Link to ="/Contact_Form" className="btn-br bg-btn3 btshad-b2 lnk">Logout <span className="circle"></span></Link> </li>      
        */}    
